...
import {
  ButtonVariant,
  Size,
} from './components/actions/key-button/key-button';
...
import {
  CrossAxisAlignment,
  MainAxisAlignment,
} from './components/structure/key-grid/alignments';
...
import {
  ParagraphSize,
  ParagraphVariant,
} from './components/text/key-paragraph/key-paragraph';
import {
  SpacerDirection,
  SpacerSize,
} from './components/structure/key-spacer/key-spacer';
...
declare global {
  interface HTMLKeyAppFrameElement
    extends Components.KeyAppFrame,
      HTMLStencilElement {}
  var HTMLKeyAppFrameElement: {
    prototype: HTMLKeyAppFrameElement;
    new (): HTMLKeyAppFrameElement;
  };
  interface HTMLKeyAppPageElement
    extends Components.KeyAppPage,
      HTMLStencilElement {}
  var HTMLKeyAppPageElement: {
    prototype: HTMLKeyAppPageElement;
    new (): HTMLKeyAppPageElement;
  };
  interface HTMLKeyBannerElement
    extends Components.KeyBanner,
      HTMLStencilElement {}
  ...
  interface HTMLKeyCardSectionElement
    extends Components.KeyCardSection,
      HTMLStencilElement {}
  var HTMLKeyCardSectionElement: {
    prototype: HTMLKeyCardSectionElement;
    new (): HTMLKeyCardSectionElement;
  };
  interface HTMLKeyCheckboxElement
    extends Components.KeyCheckbox,
      HTMLStencilElement {}
  ...
  interface HTMLKeyFontAwesomeKitProviderElement
    extends Components.KeyFontAwesomeKitProvider,
      HTMLStencilElement {}
  ...
  interface HTMLKeyGridItemElement
    extends Components.KeyGridItem,
      HTMLStencilElement {}
  var HTMLKeyGridItemElement: {
    prototype: HTMLKeyGridItemElement;
    new (): HTMLKeyGridItemElement;
  };
  interface HTMLKeyHeadingElement
    extends Components.KeyHeading,
      HTMLStencilElement {}
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      'key-app-frame': LocalJSX.KeyAppFrame &
        JSXBase.HTMLAttributes<HTMLKeyAppFrameElement>;
      'key-app-page': LocalJSX.KeyAppPage &
        JSXBase.HTMLAttributes<HTMLKeyAppPageElement>;
      'key-banner': LocalJSX.KeyBanner &
        JSXBase.HTMLAttributes<HTMLKeyBannerElement>;
      ...
      'key-card-section': LocalJSX.KeyCardSection &
        JSXBase.HTMLAttributes<HTMLKeyCardSectionElement>;
      'key-checkbox': LocalJSX.KeyCheckbox &
        JSXBase.HTMLAttributes<HTMLKeyCheckboxElement>;
      'key-flex': LocalJSX.KeyFlex & JSXBase.HTMLAttributes<HTMLKeyFlexElement>;
      'key-font-awesome-kit-provider': LocalJSX.KeyFontAwesomeKitProvider &
        JSXBase.HTMLAttributes<HTMLKeyFontAwesomeKitProviderElement>;
      'key-grid': LocalJSX.KeyGrid & JSXBase.HTMLAttributes<HTMLKeyGridElement>;
      'key-grid-item': LocalJSX.KeyGridItem &
        JSXBase.HTMLAttributes<HTMLKeyGridItemElement>;
      'key-heading': LocalJSX.KeyHeading &
        JSXBase.HTMLAttributes<HTMLKeyHeadingElement>;
      'key-icon': LocalJSX.KeyIcon & JSXBase.HTMLAttributes<HTMLKeyIconElement>;
      'key-input': LocalJSX.KeyInput &
        JSXBase.HTMLAttributes<HTMLKeyInputElement>;
      'key-label': LocalJSX.KeyLabel &
        JSXBase.HTMLAttributes<HTMLKeyLabelElement>;
      'key-layout': LocalJSX.KeyLayout &
        JSXBase.HTMLAttributes<HTMLKeyLayoutElement>;
      'key-page-actions': LocalJSX.KeyPageActions &
        JSXBase.HTMLAttributes<HTMLKeyPageActionsElement>;
      'key-paragraph': LocalJSX.KeyParagraph &
        JSXBase.HTMLAttributes<HTMLKeyParagraphElement>;
      'key-spacer': LocalJSX.KeySpacer &
        JSXBase.HTMLAttributes<HTMLKeySpacerElement>;
      'key-spinner': LocalJSX.KeySpinner &
        JSXBase.HTMLAttributes<HTMLKeySpinnerElement>;
      'key-visually-hidden': LocalJSX.KeyVisuallyHidden &
        JSXBase.HTMLAttributes<HTMLKeyVisuallyHiddenElement>;
    }
  }
}
